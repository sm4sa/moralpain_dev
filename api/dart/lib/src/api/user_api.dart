...
class UserApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [ResiliencyResources] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<ResiliencyResources>> getResiliencyResources({ 
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<String>> submitSubmissionTypeDB({ 
  ...
  /// Returns a [Future] containing a [Response] with a [String] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<String>> submitSurvey({ 
    Submission? submission,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [String] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<String>> submitVisitedResiliencyResources({ 
