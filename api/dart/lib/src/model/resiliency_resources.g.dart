...
class _$ResiliencyResources extends ResiliencyResources {
  ...
  factory _$ResiliencyResources(
      ...
      (new ResiliencyResourcesBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ResiliencyResources')
          ..add('version', version)
...
class ResiliencyResourcesBuilder
  ...
  @override
  ResiliencyResources build() => _build();

  _$ResiliencyResources _build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'ResiliencyResources', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
