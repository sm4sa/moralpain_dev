 ...
 *
 */
public class SubmissionUpdater implements RequestHandler<APIGatewayV2HTTPEvent, APIGatewayV2HTTPResponse> {
    ...
    public APIGatewayV2HTTPResponse handleRequest(APIGatewayV2HTTPEvent apiGatewayV2HTTPEvent, Context context) {
        ...
        String uploadFileName = variableManager.getOrDefault("uploadFileName", createKey());
        String key = prefix.isEmpty() ? uploadFileName : String.join("/", prefix, uploadFileName);
